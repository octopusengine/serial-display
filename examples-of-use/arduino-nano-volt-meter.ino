...
void setup(void) {
  ...
  //if (test){  Serial.println(tft.readID()); }
   ...
   Serial.print("W8");
   //for (int vv=2;vv<6;vv++){
   //Serial.print("h");
   //Serial.print(volt2gr5(vv));
   for (int vv=20;vv<80;vv++){
   Serial.print("h");
   Serial.print(volt2gr120(float(vv*2))); //desetina
   delay(20);}

   Serial.print("W8"); //po 10 min
   for (int tt=0;tt<32;tt++){
   Serial.print("v");
   Serial.print(tt*15); //tt*30> sum necele 2 hod. ///
   delay(20);}
   ...
   Serial.print("R0");
   Serial.println("Q SERIAL MONITOR (12 Volt)*"); //prepis text na pozici 10/30/50/70/..
   delay(30);   
   Serial.print("R10");
   //delay(100);
   Serial.print("Q11.12.13 V     3 hod.*"); 
