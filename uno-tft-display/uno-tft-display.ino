...
//--------------------------------------------------
#define SN "15xxyy"
#define VER "2021-06-12 [115200Bd] " //
#define BAUDRATE 115200 // 9600 for ATtiny or 115200 for RPi oe ESP32
int test = 1; // 0/1
...
void loop()
{
  while (Serial.available() > 0) {
    ...
    //------------------------------------------------------G 
    if (sel == 'G')  {   //togoTxt(); set rotation
       int sr = Serial.parseInt();
       //default: tft.setRotation(1);//oe 
       tft.setRotation(sr);    
    }
